Ahora que ya conoce los servicios disponibles de Azure Compute, vamos a echar un vistazo a cada uno de ellos por separado, para ayudarle a decidir cuándo debe usar cada servicio.
